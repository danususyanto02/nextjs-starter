...
export default async function RolesPage() {
  ...
  return <ResourceCrud resourceType="role" assignment={{ label: "Permissions", endpointSuffix: "permissions", permission: "ED0000003", payloadKey: "permissionIds" }} title="Roles" description="Manage roles and permission assignments." endpoint="/api/v1/roles" permissions={{ add: "AD0000003", edit: "ED0000003", remove: "DD0000003" }} fields={[{ name: "name", label: "Name", required: true }, { name: "code", label: "Code", required: true }, { name: "status", label: "Status", type: "select", options: ["ACTIVE", "DISABLED"] }]} columns={[{ key: "name", label: "Name" }, { key: "code", label: "Code" }, { key: "status", label: "Status" }]} />;
}
